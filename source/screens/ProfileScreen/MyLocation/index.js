...
import { TouchableOpacity, View, Text, Button, StyleSheet, KeyboardAvoidingView, Keyboard, ActivityIndicator } from 'react-native';
  ...
  return (
    <GestureHandlerRootView>
      <Screen statusBarColor={appColors.Black} barStyle="dark-content">
        <KeyboardAvoidingView style={{ flex: 1, backgroundColor: appColors.Black }} behavior={Platform.OS === "ios" ? "padding" : null}
          ...
          <View style={{ flex: 1, backgroundColor: appColors.Black }}>
            ...
            <BottomSheet
              index={0}
              snapPoints={keyboardFocusRef?.current?.isFocused() ? keyboardSnapPoint : snapPoints}
