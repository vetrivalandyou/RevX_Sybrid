...
const LocationBottom = ({ refRBSheet }) => {
    ...
    return (
        <View style={[logoutStyle.container]}>
            ...
            <View style={{ flex: 0.4, backgroundColor: appColors.Gray, borderRadius: 20, }}>
                <View style={{ flex: 1,  justifyContent: 'space-between', flexDirection: "row", padding: 10 }}>
                    <View style={{ flex: 0.3,alignItems:'center'}}>
                        <Image source={AppImages.bottomsheetimg} style={{flex:1,resizeMode:'contain'}} />
                    ...
                    <View style={{ flex: 0.7, }}>
                        ...
                        <View style={{ flex: 0.3,  flexDirection: 'row' }}>
                            <View style={{ flex: 0.5, flexWrap: 'wrap' }}>
                                <Text style={{ fontSize: 16, color: appColors.White,fontWeight:'500' }}>
                                    Nathan Alexender
                                </Text>
                            </View>
                            ...
                            <View style={{ flex: 0.5, flexDirection: 'row', justifyContent: 'flex-end' }}>
                                ...
                                <View style={{ flex: 0.6, justifyContent: 'center', alignItems: 'flex-end'}}>
                                    <CustomIcon type={Icons.Ionicons} name={'timer-outline'} size={16} color={appColors.Goldcolor}/>
                                </View>
                                <View style={{ flex: 0.4, justifyContent: 'center',  marginLeft: 2 }}>
                        ...
                        <View style={{flex: 0.7 }}>
                            ...
                            <View style={{ flex: 0.5,flexDirection: 'row' }}>
                                <View style={{ flexDirection: 'row', flex: 0.2 }}>
                                    <CustomIcon type={Icons.Feather} name={"map-pin"} color={appColors.White} size={13} />
                                    <Text style={{ color: appColors.White, marginLeft: 5, fontSize: 10.4 }}>km</Text>
                                </View>
                                <View style={{ flexDirection: 'row', flex: 0.8 }}>
                                    <CustomIcon type={Icons.AntDesign} name={"staro"} color={"yellow"} size={13} />
                                    <Text style={{ color: appColors.White, marginLeft: 5, fontSize: 10.4 }}>4.1 rating</Text>
                                </View>
            ...
            <View style={{ flex: 0.3, justifyContent: 'center' }}>
                <ButtonComponent title={"Get direction"} style={{ backgroundColor: appColors.Gray }} />
