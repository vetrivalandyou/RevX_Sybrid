...
const ScreenSlider=({navigation})=>{
  ...
  const imageData=[
    ...
    {image:AppImages.slider1, text: 'Find Barber & Salons Easily in Your Hands'},
    {image:AppImages.slider2, text: 'Book Your Favorite Barber & Salon Quickly'},
    {image:AppImages.slider3, text: 'Schedule the Appointment in the best Salon'},   
]
